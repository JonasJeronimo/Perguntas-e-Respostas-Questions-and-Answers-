...
void apresentacao(string nome){
	...
	cin >> nome;
	cout << "\nSaudações, " << nome << "\n\n";
	cout << "Você será posto à prova nesse programa, iremos apresentar 15 perguntas e você receberá uma quantidade de dinheiro para cada resposta correta. À cada 5 perguntas, você alcançará um checkpoint.\n";
	cout << "\n\nVAMOS COMEÇAR!!!\n\n\n";
}
